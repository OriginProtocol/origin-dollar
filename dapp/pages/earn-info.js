    ...
    <Layout locale={locale}>
          ...
          <div className="hangers">
            ...
            <div className="d-flex justify-content-center">
              <div className="source">
                <img
                  src={assetRootPathOption('/images/yield-1-icon-small.svg')}
                  alt="Lending fees"
                />
              </div>
              <div className="source">
                <img
                  src={assetRootPathOption('/images/yield-2-icon-small.svg')}
                  alt="Trading fees"
                />
              </div>
              <div className="source">
                <img
                  src={assetRootPathOption('/images/yield-3-icon-small.svg')}
      ...
      <section className="bonus">
        <div className="container text-center px-lg-0">
          <img
            src={assetRootPathOption('/images/yield-4-icon-small.svg')}
        ...
        <div className="container text-center text-lg-left px-lg-0">
          <div className="row">
            <div className="col-lg-5 text-center order-lg-2 d-flex justify-content-lg-end justify-content-center">
              <img
                src={assetRootPathOption('/images/yield-1-icon-large.svg')}
                alt="Lending fees"
                ...
                <div className="d-flex logos">
                  <div className="d-flex flex-column logo align-items-start">
                    <div className="d-flex justify-content-center">
                      <img
                        className="w-sd-103"
                        src={assetRootPathOption('/images/compound-logo.svg')}
                        alt="Compound logo"
                      />
                    </div>
                  </div>
                  <div className="d-flex flex-column logo align-items-start">
                    <div className="d-flex justify-content-center">
                      <img
                        className="w-sd-62"
                        src={assetRootPathOption('/images/aave-logo.svg')}
                        alt="Aave logo"
                      />
                    </div>
                  </div>
                  <div className="d-flex flex-column logo align-items-start">
                    <div className="d-flex justify-content-center">
                      <img
                        className="w-sd-66"
                        src={assetRootPathOption('/images/dydx-logo.svg')}
                        alt="dy/dx logo"
                      />
                    </div>
                    <div className="label">
          ...
          <div className="row">
            <div className="col-lg-6 text-center">
              <img
                src={assetRootPathOption('/images/yield-2-icon-large.svg')}
                alt="Lending fees"
                className="category w-sd-116 h-sd-116"
              />
            </div>
                ...
                <div className="d-flex logos">
                  <div className="d-flex flex-column logo align-items-start">
                    <div className="d-flex justify-content-center">
                      <img
                        className="w-sd-97"
                        src={assetRootPathOption('/images/uniswap-logo.svg')}
                        alt="Uniswap logo"
                      />
                    </div>
                    <div className="label">
                  ...
                  <div className="d-flex flex-column logo align-items-start">
                    <div className="d-flex justify-content-center">
                      <img
                        className="w-sd-78"
                        src={assetRootPathOption('/images/balancer-logo.svg')}
                        alt="Balancer logo"
                      />
                    </div>
                    <div className="label">
                  ...
                  <div className="d-flex flex-column logo align-items-start">
                    <div className="d-flex justify-content-center">
                      <img
                        className="w-sd-71"
                        src={assetRootPathOption('/images/curve-logo.svg')}
                        alt="Curve logo"
                      />
                    </div>
                  </div>
          ...
          <div className="row">
            <div className="col-lg-6 text-center order-lg-2">
              <img
                src={assetRootPathOption('/images/yield-3-icon-large.svg')}
                alt="Liquidity Mining Rewards"
      ...
      <section className="dark compounding">
        <div className="container text-center px-lg-0">
          ...
          <div className="image-container">
            ...
            <img
              src={assetRootPathOption('/images/compound-graph-lg.svg')}
              alt="Compounding graph"
              className="d-none d-lg-block"
            />
            <img
              src={assetRootPathOption('/images/compound-graph-xs.svg')}
              alt="Compounding graph"
              className="d-lg-none"
            />
