        ...
        <div>
          <div className='flex flex-col md:flex-row overflow-hidden max-w-screen-xl mx-auto md:pt-10 px-8 pb-20 text-center md:text-left'>
            <div>
              ...
              <div className=" flex flex-col justify-between w-full md:w-4/5 h-48 mb-20 text-left font-weight-bold mt-10 md:mt-24 h-36 md:h-52">
                <div className="flex flex-row justify-between">
                  <div className='w-96'>
                    <Typography.Body2 className='text-xs md:text-base mb-2 font-weight-bold'>{'OGV PRICE'}</Typography.Body2>
                    <Typography.H5>{`$${formatCurrency(price, 4)}`}</Typography.H5>
                  </div>
                  <div className='w-96'>
                    <Typography.Body2 className='text-xs md:text-base mb-2 font-weight-bold'>{'OGV MARKET CAP'}</Typography.Body2>
                    <Typography.H5>{`$${formatCurrency(circulatingSupply * price, 0)}`}</Typography.H5>
                  </div>
                </div>
                <div className="flex flex-row justify-between">
                  <div className='w-96'>
                    <Typography.Body2 className='text-xs md:text-base mb-2 font-weight-bold'>{'CIRCULATING SUPPLY'}</Typography.Body2>
                    <Typography.H5>{formatCurrency(circulatingSupply, 0)}</Typography.H5>
                  </div>
                  <div className='w-96'>
                    <Typography.Body2 className='text-xs md:text-base mb-2 font-weight-bold'>{'TOTAL SUPPLY'}</Typography.Body2>
                    <Typography.H5>{formatCurrency(totalSupply, 0)}</Typography.H5>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              />
              <Typography.Body2 className='my-4 opacity-75 text-center'>OGV is listed on top exchanges</Typography.Body2>
              <div className='flex flex-row justify-between'>
                <img
          ...
          <div className='overflow-hidden max-w-screen-xl mx-auto mt-16 md:pt-28 px-8 pb-10 md:pb-20 text-center'>
            <div>
              ...
              <Typography.Body2 className='mb-10 font-light'>
                Fees and voting rights accrue to OGV stakers. Control the future of OUSD <br className="hidden md:block" />
