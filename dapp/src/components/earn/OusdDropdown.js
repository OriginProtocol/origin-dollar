...
const OusdDropdown = ({ }) => {
  ...
  const ousdBalance = Number(useStoreState(AccountStore, (s) => s.balances.ousd))

  return (
    <>
      {ousdBalance > 0 && <Dropdown
        content={
          <div className="dropdown-menu show wrapper">
            ...
            <div className="stats-holder">
              ...
              <div className="stat-item d-flex justify-content-between">
                <div className="stat">{fbt('Circulating Supply', 'Circulating Supply')}</div>
                <div className="value">$1</div>
              </div>
              <div className="stat-item d-flex justify-content-between">
              ...
              <a className="btn-dark" href="http://analytics.ousd.com/" target="_blank" rel="noopener noreferrer">
      ...
      >
        ...
        >
          <a
            href="#"
            children={<div className={`d-flex align-items-center justify-content-center ${open ? 'open' : ''}`}>
