  ...
  return <>
    ...
    {dapp && (
      <div className="d-flex align-items-center justify-content-center dapp-navigation mr-auto flex-wrap">
        <Link href={adjustLinkHref('/')} legacyBehavior>
          <a
        ...
        {process.env.ENABLE_LIQUIDITY_MINING === 'true' && (
          <Link href={adjustLinkHref('/earn')} legacyBehavior>
            <a
        ...
        <Link href={adjustLinkHref('/wrap')} legacyBehavior>
          <a
            className={`d-flex align-items-center ${
              page === 'wrap' ? 'selected' : ''
            }`}
        ...
        <Link href={adjustLinkHref('/history')} legacyBehavior>
          <a
            className={`d-flex align-items-center ${
          ...
          <div className="d-flex flex-column flex-lg-row mb-auto w-100 align-items-center">
            {!dapp && (
              <ul className={`navbar-nav ${!dapp ? 'ml-auto' : ''}`}>
                ...
                >
                  <Link href={adjustLinkHref('/earn-info')} legacyBehavior>
                    <a className="nav-link">
                ...
                >
                  <Link href={adjustLinkHref('/governance')} legacyBehavior>
                    <a className="nav-link">
            ...
            {dapp && environment !== 'production' && (
              <ul className="navbar-nav">
                <li className="nav-item mr-2">
                  <Link href={adjustLinkHref('/dashboard')} legacyBehavior>
