      ...
      {coin === 'mix' && (
        <div className="d-flex align-items-start">
          <img
            ...
            src={adjustSrcOption(`/images/currency/dai-icon-small.svg`)}
          />
          <img
            className={`${className} mixed coin-2 ${small ? 'small' : ''}`}
            src={adjustSrcOption(`/images/currency/usdt-icon-small.svg`)}
          />
          <img
            className={`${className} mixed coin-3 ${small ? 'small' : ''}`}
            src={adjustSrcOption(`/images/currency/usdc-icon-small.svg`)}
          />
        </div>
      )}
      <style jsx>{`
