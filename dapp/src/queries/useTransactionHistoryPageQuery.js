...
const useTransactionHistoryPageQuery = (account, transactionHistoryItemsPerPage, options) => {
  return useQuery(
    QUERY_KEYS.TransactionHistoryPage(account),
    () => transactionHistoryPageService.fetchHistory(account, transactionHistoryItemsPerPage),
    {
