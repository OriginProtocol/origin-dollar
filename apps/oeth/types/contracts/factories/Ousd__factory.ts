...
import type { Ousd, OusdInterface } from "../Ousd";
...
export class Ousd__factory {
  static readonly abi = _abi;
  static createInterface(): OusdInterface {
    return new utils.Interface(_abi) as OusdInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): Ousd {
    return new Contract(address, _abi, signerOrProvider) as Ousd;
  }
}
