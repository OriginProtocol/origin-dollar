...
certoraRun VaultHarness.sol ../spec/harnesses/DummyERC20A.sol ../spec/harnesses/DummyERC20B.sol contracts/strategies/AaveStrategy.sol contracts/strategies/CompoundStrategy.sol contracts/strategies/ThreePoolStrategy.sol \
