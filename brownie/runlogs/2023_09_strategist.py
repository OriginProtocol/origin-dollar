...
with TemporaryForkForReallocations() as txs:
  ...
  # Strategist
  txs.append(vault_oeth_admin.withdrawFromStrategy(OETH_CONVEX_OETH_ETH_STRAT, [weth], [1_432 * 10**18], {'from': STRATEGIST}))
  txs.append(vault_oeth_admin.depositToStrategy(FRAX_ETH_STRATEGY, [weth], [1_664*10**18], {'from': STRATEGIST}))
