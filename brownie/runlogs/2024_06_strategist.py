...
# -------------------------------------
# Jun 19, 2024 - Next batch of ETH for the Native Staking Strategy
# -------------------------------------
from world import *
...
def main():
  with TemporaryForkForReallocations() as txs:
    ...
    # Burn about 1,936 OETH that was just minted
    metapool_virtual_price = 1001553729891236190
    lp_amount = 1936 * 10**18 * 10**18 / metapool_virtual_price
    txs.append(
