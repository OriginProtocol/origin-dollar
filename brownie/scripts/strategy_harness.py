...
class BalancerRethEth:
    ...
    def tilt_pool(self, size):
        ...
        if size == 0:            
            ...
            # swapping RETH specified by amount for WETH
            self._balancer_vault.swap((self._pool_pid, 0, RETH, WETH, amount, ""), (RETH_WHALE, False, RETH_WHALE, False), 1, chain.time()+100, {"from": RETH_WHALE})
...
#             withdraw = harness.pool_create_mix(deposit_mix, size=0.1)
