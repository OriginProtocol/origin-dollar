...
library Mainnet {
    ...
    address public constant OETH_VAULT =
        0x39254033945AA2E4809Cc2977E7087BEE48bd7Ab;
    address public constant OETH_VAULT_VALUE_CHECKER =
        0x31FD8618379D8e473Ec2B1540B906E8e11D2A99b;

    // OETH Strategies
    address public constant OETH_WETH_CURVE_AMO =
        0xba0e352AB5c13861C26e4E773e7a833C3A223FE6;
    address public constant NATIVE_STAKING_STRATEGY_2 =
        0x4685dB8bF2Df743c861d71E6cFb5347222992076;
    address public constant NATIVE_STAKING_STRATEGY_3 =
        0xE98538A0e8C2871C2482e1Be8cC6bd9F8E8fFD63;

    // Pool Booster
    address public constant POOL_BOOSTER_FACTORY_MERKL =
        0x0FC66355B681503eFeE7741BD848080d809FD6db;
    ...
    // Curve pools
    address public constant OETH_WETH_CURVE_POOL =
        0xcc7d5785AD5755B6164e21495E07aDb0Ff11C2A8;

    // ARMs
    address public constant ETHERFI_ARM =
        0xfB0A3CF9B019BFd8827443d131b235B3E0FC58d2;

    // SSV
    address public constant SSV = 0x9D65fF81a3c488d585bBfb0Bfe3c7707c7917f54;
...
library Base {
    ...
    address public constant OETHB_VAULT =
        0x98a0CbeF61bD2D21435f433bE4CD42B56B38CC93;
    address public constant OETHB_VAULT_VALUE_CHECKER =
        0x9D98Cf85B65Fa1ACef5e9AAA2300753aDF7bcf6A;

    // OETHb Strategies
    address public constant OETHB_WETH_CURVE_AMO =
        0x9cfcAF81600155e01c63e4D2993A8A81A8205829;
    address public constant OETHB_WETH_AERODROME_POOL =
        0xF611cC500eEE7E4e4763A05FE623E2363c86d2Af;

    // Pool Booster
    address public constant POOL_BOOSTER_FACTORY_MERKL =
        0x1ADB902Ece465cA681C66187627a622a631a0a63;
    address public constant POOL_BOOSTER_CENTRAL_REGISTRY =
    ...
    // Curve pools
    address public constant OETHB_WETH_CURVE_POOL =
...
library Sonic {
    ...
    address public constant OS_VAULT =
        0xa3c0eCA00D2B76b4d1F170b0AB3FdeA16C180186;
    address public constant OS_VAULT_VALUE_CHECKER =
    ...
    // Strategies
    address public constant STAKING_STRATEGY =
