...
/// @dev This implementation is supposed to be used on mainnet only.
/// @dev For L2 utilization, see `PoolBoosterCurveL2.sol`.
contract PoolBoosterCurveMainnet is Initializable, Strategizable, IPoolBooster {
    ...
    function createCampaign(
        ...
        emit BribeExecuted(balanceSubFee);
    }
