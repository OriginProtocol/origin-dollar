...
contract MockCToken is ICERC20, ERC20 {
    ...
    constructor(ERC20 _underlyingToken, address _comptroller) ERC20("cMock", "cMK") {
    ...
    function balanceOf(address owner) public view override(ICERC20, ERC20) returns (uint256) {
