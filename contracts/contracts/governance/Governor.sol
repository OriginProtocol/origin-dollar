...
/**
Adapted from Compound

https://github.com/compound-finance/compound-protocol/blob/master/contracts/Governance/Governor.sol
...
contract Governor {
    ...
    string public constant name = "OUSD Governor";
    ...
    // @notice The number of votes required in order for a voter to become a
    // proposer
    ...
    // @notice The delay before voting on a proposal may take place, once
    // proposed
    ...
    struct Proposal {
        ...
        address[] targets;
        // @notice The ordered list of values (i.e. msg.value) to be passed to
        ...
        bytes[] calldatas;
        // @notice The block at which voting begins: holders must delegate
        // their votes prior to this block
        uint256 startBlock;
        // @notice The block at which voting ends: votes must be cast prior to
        // this block
        uint256 endBlock;
