...
import { CurveTwoCoinLib } from "./curve/CurveTwoCoinLib.sol";
import { ConvexStrategy, BaseCurveStrategy } from "./ConvexStrategy.sol";

contract TwoPoolConvexStrategy is ConvexStrategy {
    constructor(
    ...
    function _curve_add_liquidity(
        ...
        CurveTwoCoinLib.add_liquidity(_pool, _amounts, _min_mint_amount);
    }
    ...
    function _curveCalcWithdrawLpAmount(
        ...
        lpAmount = CurveTwoCoinLib.calcWithdrawLpAmount(
            _pool,
            _coinIndex,
            _assetAmount
        );
    ...
    function _curve_remove_liquidity_imbalance(
        ...
        CurveTwoCoinLib.remove_liquidity_imbalance(
            _pool,
            _amount,
            _coin_index,
            _max_burn_amount,
    ...
    function _curve_remove_liquidity(
        ...
        CurveTwoCoinLib.remove_liquidity(_pool, _burn_amount, _min_amounts);
    }
}
