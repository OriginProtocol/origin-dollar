...
interface IVotemarket {
    ...
    function addressesByCampaignId(uint256) external view returns (uint256 _spacer);
    ...
    function claim(uint256 campaignId, uint256 epoch, bytes memory hookData, address receiver)
        external
        returns (uint256 claimed);
    function claim(uint256 campaignId, address account, uint256 epoch, bytes memory hookData)
        external
        returns (uint256 claimed);
    ...
    function getAddressesByCampaign(uint256 campaignId) external view returns (address[] memory);
    function getCampaign(uint256 campaignId) external view returns (Campaign memory);
    function getCampaignUpgrade(uint256 campaignId, uint256 epoch) external view returns (CampaignUpgrade memory);
    ...
    function increaseTotalRewardAmount(uint256 campaignId, uint256 totalRewardAmount) external;
    ...
    function periodByCampaignId(uint256, uint256)
        external
        view
        returns (uint256 rewardPerPeriod, uint256 rewardPerVote, uint256 leftover, bool updated);
    ...
    function totalClaimedByAccount(uint256, uint256, address) external view returns (uint256);
    ...
    function updateEpoch(uint256 campaignId, uint256 epoch, bytes memory hookData) external returns (uint256 epoch_);
