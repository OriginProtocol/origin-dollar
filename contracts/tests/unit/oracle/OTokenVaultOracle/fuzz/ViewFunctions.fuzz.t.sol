...
contract Unit_Fuzz_OTokenVaultOracle_ViewFunctions_Test is Unit_OTokenVaultOracle_Shared_Test {
    /// @notice The oracle always reports total value divided by total supply with 18 decimals.
    function testFuzz_price_reportsAssetValuePerOToken(uint256 totalValue, uint256 totalSupply) public {
