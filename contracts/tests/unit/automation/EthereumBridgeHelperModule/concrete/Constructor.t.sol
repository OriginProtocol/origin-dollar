...
contract Unit_Concrete_EthereumBridgeHelperModule_Constructor_Test
    is Unit_EthereumBridgeHelperModule_Shared_Test
{
    ...
    function test_constructor_safeContractSet() public view {
        assertEq(
            address(ethereumBridgeHelperModule.safeContract()),
            address(mockSafe)
        );
    }
    ...
    function test_constructor_safeHasAdminRole() public view {
        assertTrue(
            ethereumBridgeHelperModule.hasRole(
                ethereumBridgeHelperModule.DEFAULT_ADMIN_ROLE(), address(mockSafe)
            )
        );
    }
    ...
    function test_constructor_vaultConstant() public view {
        assertEq(
            address(ethereumBridgeHelperModule.vault()),
    ...
    function test_constructor_wethConstant() public view {
        assertEq(
            address(ethereumBridgeHelperModule.weth()),
    ...
    function test_constructor_oethConstant() public view {
        assertEq(
            address(ethereumBridgeHelperModule.oeth()),
    ...
    function test_constructor_woethConstant() public view {
        assertEq(
            address(ethereumBridgeHelperModule.woeth()),
    ...
    function test_constructor_ccipRouterConstant() public view {
        assertEq(
            address(ethereumBridgeHelperModule.CCIP_ROUTER()),
    ...
    function test_constructor_ccipBaseChainSelectorConstant() public view {
        assertEq(
            ethereumBridgeHelperModule.CCIP_BASE_CHAIN_SELECTOR(),
