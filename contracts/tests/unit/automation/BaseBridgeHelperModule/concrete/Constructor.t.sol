...
contract Unit_Concrete_BaseBridgeHelperModule_Constructor_Test
    is Unit_BaseBridgeHelperModule_Shared_Test
{
    ...
    function test_constructor_safeContractSet() public view {
        assertEq(
            address(baseBridgeHelperModule.safeContract()),
            address(mockSafe)
        );
    }
    ...
    function test_constructor_safeHasAdminRole() public view {
        assertTrue(
            baseBridgeHelperModule.hasRole(
                baseBridgeHelperModule.DEFAULT_ADMIN_ROLE(), address(mockSafe)
            )
        );
    }
    ...
    function test_constructor_vaultConstant() public view {
        assertEq(
            address(baseBridgeHelperModule.vault()),
    ...
    function test_constructor_wethConstant() public view {
        assertEq(
            address(baseBridgeHelperModule.weth()),
    ...
    function test_constructor_oethbConstant() public view {
        assertEq(
            address(baseBridgeHelperModule.oethb()),
    ...
    function test_constructor_bridgedWOETHConstant() public view {
        assertEq(
            address(baseBridgeHelperModule.bridgedWOETH()),
    ...
    function test_constructor_bridgedWOETHStrategyConstant() public view {
        assertEq(
            address(baseBridgeHelperModule.bridgedWOETHStrategy()),
    ...
    function test_constructor_ccipRouterConstant() public view {
        assertEq(
            address(baseBridgeHelperModule.CCIP_ROUTER()),
    ...
    function test_constructor_ccipEthereumChainSelectorConstant() public view {
        assertEq(
            baseBridgeHelperModule.CCIP_ETHEREUM_CHAIN_SELECTOR(),
            5009297550715157269
        );
    }
}
