...
abstract contract Smoke_CrossChainRemoteStrategyHyperEVM_Shared_Test is BaseSmoke {
    ...
    function _replaceTokenMessenger() internal {
        CCTPTokenMessengerMock temp = new CCTPTokenMessengerMock(HyperEVM.USDC, CrossChain.CCTPMessageTransmitterV2);
        vm.etch(CrossChain.CCTPTokenMessengerV2, address(temp).code);
