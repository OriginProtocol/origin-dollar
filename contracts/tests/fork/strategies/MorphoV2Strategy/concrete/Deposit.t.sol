...
import {Fork_MorphoV2Strategy_Shared_Test} from "tests/fork/strategies/MorphoV2Strategy/shared/Shared.t.sol";
...
contract Fork_Concrete_MorphoV2Strategy_Deposit_Test is Fork_MorphoV2Strategy_Shared_Test {
    ...
    function test_deposit_emitsDepositEvent() public {
        ...
        emit InitializableAbstractStrategy.Deposit(Mainnet.USDC, Mainnet.MorphoOUSDv2Vault, amount);
