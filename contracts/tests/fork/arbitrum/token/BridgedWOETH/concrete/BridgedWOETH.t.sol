...
import {ArbitrumOne} from "tests/utils/Addresses.sol";

import {IBridgedWOETH} from "contracts/interfaces/IBridgedWOETH.sol";

contract Fork_Concrete_Arbitrum_BridgedWOETH_Test is BaseFork {
    ...
    function setUp() public override {
        super.setUp();
        _createAndSelectForkArbitrum();
        bridgedWOETH = IBridgedWOETH(ArbitrumOne.WOETHProxy);
