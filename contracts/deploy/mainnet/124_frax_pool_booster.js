...
module.exports = deploymentWithGovernanceProposal(
  ...
  async ({ withConfirmation }) => {
    ...
    const governor = addresses.mainnet.Timelock;
    ...
    return {
      name: "Delegate Yield from frxETH/OETH Curve Pool to corresponding Pool Booster",
      actions: [
        {
          contract: OETH,
          signature: "delegateYield(address,address)",
          args: [curvePool, poolBoosterProxyAddress],
        },
      ],
    };
  }
