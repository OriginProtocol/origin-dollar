...
module.exports = deploymentWithGovernanceProposal(
  ...
  async ({ deployWithConfirmation, ethers, getTxOpts }) => {
    ...
    const cOUSDVault = await ethers.getContractAt("IVault", cOUSDVaultProxy.address);
    const cOETHVault = await ethers.getContractAt("IVault", cOETHVaultProxy.address);
    ...
    const cOUSDHarvester = await ethers.getContractAt("Harvester", cOUSDHarvesterProxy.address);
    const cOETHHarvester = await ethers.getContractAt("OETHHarvester", cOETHHarvesterProxy.address);
    ...
    // 3. Deploy Harvester
    await deployWithConfirmation("Harvester", [
      cOUSDVault.address,
    ...
    const setRewardTokenConfigSig = "setRewardTokenConfig(address,(uint16,uint16,address,bool,uint8,uint256),bytes)"
