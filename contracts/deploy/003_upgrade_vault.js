...
const upgradeVaultCoreAndAdmin = async ({ getNamedAccounts }) => {
  ...
  if (isMainnet) {
    ...
    console.log("Set default Strategy for DAI");
    await cVault
      .connect(sGovernor)
      .setAssetDefaultStrategy(
    ...
    console.log("Set default Strategy for USDC");
    await cVault
      .connect(sGovernor)
      .setAssetDefaultStrategy(
    ...
    console.log("Set default Strategy for USDT");
  } else {
    ...
    const upgradeArgs = await proposeArgs([
      ...
      },
      {
        ...
        args: [addresses.mainnet.DAI, cAaveStrategyProxy.address],
      },
      {
        contract: cVaultAdmin,
        signature: "setAssetDefaultStrategy(address,address)",
        args: [addresses.mainnet.USDC, cCompoundStrategyProxy.address],
      },
      {
        contract: cVaultAdmin,
        signature: "setAssetDefaultStrategy(address,address)",
        args: [addresses.mainnet.USDT, cCompoundStrategyProxy.address],
      },
    ]);
  ...
  console.log("003_vault_upgrade complete");

  return true;
};

upgradeVaultCoreAndAdmin.id = "003_upgrade_vault";
