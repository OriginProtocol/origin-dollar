...
module.exports = balancerStrategyDeployment({
  deploymentOpts: {
    deployName: "072_balancer_rETH_WETH",
    forceDeploy: false,
    //forceSkip: true,
  ...
  proxyContractName: "OETHBalancerMetaPoolrEthStrategyProxy",

  platformAddress,
  poolId: balancer_rETH_WETH_PID,

  auraRewardsContractAddress: addresses.mainnet.rETH_WETH_AuraRewards,

  rewardTokenAddresses: [addresses.mainnet.BAL, addresses.mainnet.AURA],
  assets: [addresses.mainnet.rETH, addresses.mainnet.WETH],
})
...
//     const cOETHVaultAdmin = await ethers.getContractAt("OETHVaultAdmin", cOETHVaultProxy.address)
