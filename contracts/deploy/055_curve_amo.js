...
module.exports = deploymentWithGuardianGovernor(
  ...
  async ({ deployWithConfirmation, ethers, getTxOpts, withConfirmation }) => {
    ...
    let { actions, tokenAddress, poolAddress, gaugeAddress, poolId } = await deployCurve({
...
const deployCurve = async ({
  ...
  await curvePool.connect(sWethWhale).add_liquidity([utils.parseUnits("50", 18), utils.parseUnits("50", 18)], 0)
