...
('origin-dollar', 'daily_snap_balances',                      'cd /app && pnpm exec tsx tasks/run.ts snapBalances --network mainnet --consol true',   '2 0 * * *',             'UTC', false, 'Remove --consol true once consolidation is finished'),
('origin-dollar', 'daily_verify_balances',                    'cd /app && pnpm exec tsx tasks/run.ts verifyBalances --network mainnet --consol true', '6 0 * * *',             'UTC', false, 'Remove --consol true once consolidation is finished'),
...
('origin-dollar', 'stake_validator',                          'cd /app && pnpm exec tsx tasks/run.ts stakeValidator --network mainnet',               '0 0 1 1 *',             'UTC', false, 'Manual validator staking. Provide amount, pubkey, sig, deposit-message-root, and optional consol.'),
('origin-dollar', 'remove_validator',                         'cd /app && pnpm exec tsx tasks/run.ts removeValidator --network mainnet',              '0 0 1 1 *',             'UTC', false, 'Manual validator removal. Provide operatorids, pubkey, and optional consol.'),
