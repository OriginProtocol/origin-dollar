...
('origin-dollar', 'otoken_oeth_rebase',                       'cd /app && pnpm hardhat otokenOethRebase --network mainnet',             '45 11,23 * * *',        'UTC', false, NULL),
('origin-dollar', 'otoken_ousd_rebase',                       'cd /app && pnpm hardhat otokenOusdRebase --network mainnet',             '45 11,23 * * *',        'UTC', false, NULL),
('origin-dollar', 'otoken_os_rebase',                         'cd /app && pnpm hardhat otokenOsRebase --network sonic',                 '45 11,23 * * *',        'UTC', false, NULL),
...
('origin-dollar', 'propose_vault_strategy_moves_mainnet',     'cd /app && pnpm hardhat proposeVaultStrategyMoves --network mainnet --vault OUSD --moves "withdrawAll:REPLACE_WITH_STRATEGY"', '0 0 1 1 *', 'UTC', false, 'Manual Ethereum launcher: replace vault and moves before Run now. Proposes a Strategist Safe transaction; never enable this schedule.'),
('origin-dollar', 'propose_vault_strategy_moves_base',        'cd /app && pnpm hardhat proposeVaultStrategyMoves --network base --vault SuperOETH --moves "withdrawAll:REPLACE_WITH_STRATEGY"', '0 0 1 1 *', 'UTC', false, 'Manual Base launcher: replace moves before Run now. Proposes a Strategist Safe transaction; never enable this schedule.'),
