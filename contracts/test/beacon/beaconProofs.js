...
describe("Beacon chain proofs", async () => {
  ...
  describe("Validator public key to beacon block root proof", () => {
    ...
    const withdrawalAddress = "0xeE45C342E7A183B1C2DEE96c7278aB3beCe36DEc";
    ...
    it("Should verify a 0x01 validator", async () => {
      ...
      const withdrawalAddress = "0xd7466C5FD68774D70A5f1590F7B51f879e192D20";
      const validatorType = 0x01;
