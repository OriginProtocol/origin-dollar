...
describe("Token", function () {
  ...
  it("Should add a non-rebasing account to the exception list", async () => {
  ...
  it("Should remove a non-rebasing account from the exception list", async () => {
    const { ousd, vault, matt, mockNonRebasing } = await loadFixture(
      defaultFixture
    );
    await mockNonRebasing.setOUSD(ousd.address);
  ...
  it("Should have a correct total supply when transferring from a non-rebasing to a rebasing account", async () => {
    const { ousd, vault, matt, mockNonRebasing } = await loadFixture(
      defaultFixture
    );
    await mockNonRebasing.setOUSD(ousd.address);
  ...
  it.only("Should have a correct total supply when transferring from a non-rebasing to a non-rebasing account", async () => {
    const { ousd, vault, matt, mockNonRebasing } = await loadFixture(
      defaultFixture
    );
    await mockNonRebasing.setOUSD(ousd.address);
